...
const Navbar = () => {
  ...
  const trackingItems = [
    {
      name: "Air Freight Tracking",
      link: "/tracking/air-freight",
      icon: Plane,
    },
  ...
  const resourceItems = [
    ...
    },
    {
      ...
      link: "/resources/metric-conversion",
      icon: Scale,
      description: "Convert units instantly",
    },
    {
      name: "Container Specifications",
      link: "/Resources/ContainerSpecifications",
      icon: Package,
      description: "Container types & sizes",
    },
    {
      name: "Shipping Glossary",
      link: "/resources/shipping-glossary",
      icon: BookOpen,
      description: "Shipping terms explained",
    },
    {
      name: "Currency Converter",
      link: "/resources/currency-converter",
      icon: Calculator,
      description: "Live exchange rates",
    },
    {
      name: "World Sea Ports",
      link: "/resources/world-ports",
      icon: Anchor,
      description: "Global port directory",
    },
    {
      name: "Truck Types",
      link: "/resources/truck-types",
      icon: TruckIcon,
  ...
  return (
    <nav className="bg-white shadow-lg sticky top-0 z-50">
      <div
        className="hidden lg:block text-white text-sm py-2"
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex gap-3">
            <button
              className="text-white px-5 py-2 rounded-lg flex items-center gap-2 transition-all hover:opacity-90"
